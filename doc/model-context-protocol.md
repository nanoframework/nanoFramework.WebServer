...
The `uri` is the unique identifier the agent uses to read the resource. Methods that take parameters or return a non-`string` type are ignored during discovery.
